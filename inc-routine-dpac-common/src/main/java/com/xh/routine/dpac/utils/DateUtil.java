...
public class DateUtil {
     ...
     * @return
     */
    public static Date toDate(LocalDateTime localDateTime, String pattern) {
        ...
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(pattern);
        LocalDateTime ldt = LocalDateTime.parse(dateTimeFormatter.format(localDateTime), dateTimeFormatter);
...
//        return null;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(toDate(plus(LocalDateTime.now(), 3, ChronoUnit.HOURS), null));
